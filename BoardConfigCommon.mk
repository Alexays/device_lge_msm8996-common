...
BOARD_KERNEL_CMDLINE := androidboot.hardware=qcom androidboot.wificountrycode=us user_debug=31 msm_rtb.filter=0x237 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 cma=32M@0-0xffffffff
